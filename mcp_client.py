...
AVIATIONSTACK_PYTHON = PROJECT_ROOT / "aviationstack-mcp" / ".venv" / "Scripts" / "python.exe"
...
client = MultiServerMCPClient(
    {
        ...
        "aviationstack": {
            "transport": "stdio",
            "command": str(AVIATIONSTACK_PYTHON),
            "args": [
                "-m",
                "aviationstack_mcp",
                "mcp",
         ...
         "weather": {
            "transport": "stdio",
            "command": r"C:\Users\shashavali\Downloads\PROJECTS\multi agent with mcp\venv\Scripts\python.exe",
            "args": [
                r"C:\Users\shashavali\Downloads\PROJECTS\multi agent with mcp\custom_weather_mcp_server.py"
            ],
            "env": {
